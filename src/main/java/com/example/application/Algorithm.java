...
public class Algorithm {
	...
	private InputBoard _board = new InputBoard();

	public List<Result> findWords(InputBoard board, List<String> words) throws ClassNotFoundException, IOException{
	...
	private void backtracking(int row, int col, TrieNode root, Result result, String direction,int startRow, int startCol) throws ClassNotFoundException, IOException {
		...
		if(currNode.word != null ) {
			...
			temp.setWord(currNode.word);
			temp.setStartpointCol(startCol);
			temp.setStartpointRow(startRow);
			temp.setEndpointRow(row);
			temp.setEndpointCol(col);
